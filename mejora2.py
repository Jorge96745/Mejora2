...
class TriviaGame(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.timer_label.color = (0, 0, 1, 1)
        ...
        Clock.schedule_interval(self.update_timer, 1.5)

    def update_rect(self, *args):
        """Actualiza el tamaño y la posición del fondo dinámico."""
    ...
    def load_question(self):
        ...
        self.question_label.color = (1, 0, 0, 1)
